...
`Monthly Performance Review — October 2026`
...
- Approved leave
- Company holidays / approved exceptions
...
- KPI 9 — Growth & Development
- KPI 10 — Role Excellence

These should be based on documented development progress and the employee's Role Success Plan rather than general impression.

## Review roles

### Review Manager

The **Review Manager** owns the final monthly review. This person is accountable for:

- reviewing all available evidence
- confirming the monthly KPI result
- assessing KPI 9 and KPI 10
- delivering feedback and running the 1:1
- agreeing next-month priorities
- finalizing the review record
...
- Record challenges / blockers
- Manager feedback
- Employee reflection
- Action items
- Next-month priorities
- Complete the 1:1 meeting

## Employee reflection

The employee should answer:
