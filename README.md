# Blinto Team Performance Framework

The Blinto Team Performance Framework defines how Blinto sets expectations, measures performance, conducts monthly reviews, and supports career growth.

## Performance philosophy

Blinto measures observable work and outcomes wherever possible. Task-level evidence is collected continuously in ClickUp, while monthly reviews add the areas that require broader managerial judgment.
...
- [Engineering Career Ladder](career-ladder-engineering.md)
- [Design Career Ladder](career-ladder-design.md)
- [Growth Career Ladder](career-ladder-growth.md)
...
- [KPI 04 — Communication](kpi-04-communication.md)
- [KPI 05 — Problem Solving](kpi-05-problem-solving.md)
- [KPI 06 — Collaboration](kpi-06-collaboration.md)
- [KPI 07 — Proactiveness](kpi-07-proactiveness.md)
- [KPI 08 — Business / Client Impact](kpi-08-business-client-impact.md)
- [KPI 09 — Growth & Development](kpi-09-growth-development.md)
- [KPI 10 — Role Excellence](kpi-10-role-excellence.md)
...
- [ClickUp Task KPI Fields](clickup-task-fields.md)
- [ClickUp KPI Review Task](clickup-kpi-review.md)
